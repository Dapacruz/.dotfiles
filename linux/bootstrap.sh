...
# ANSIBLE_CONFIG=$HOME/.dotfiles/linux/ansible/ansible.cfg ansible-pull --become-password-file become_pass.txt -i $HOSTNAME, --limit=localhost,$HOSTNAME -U https://github.com/Dapacruz/.dotfiles linux/ansible/playbooks/deploy-dotfiles.yml
